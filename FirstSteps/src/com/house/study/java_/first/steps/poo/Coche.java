...
public class Coche {
	...
	public String decirDatosGenerales() { // GETTER
		return "La plataforma del vehículo tiene " + ruedas + " ruedas. Mide " + largo / 1000 + " metros, con un"
				+ " ancho de " + ancho + " centrímetros y" + " un peso de " + pesoPlataforma + " kg.";
	}
	...
	public String decirPesoCoche() { // Método SETTER + GETTER no recomendado, es mejor hacerlo por separado
